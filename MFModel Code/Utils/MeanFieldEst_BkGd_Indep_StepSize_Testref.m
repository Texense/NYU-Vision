...
% iteration
function [f_EnIOut,meanVs,loop,SteadyIndicate] = MeanFieldEst_BkGd_Indep_StepSize_Testref(C_EE,C_EI,C_IE,C_II,... %4
...
if nargin > 38 % Specify: LIF simulation timef_pre
    LIFSimuT = varargin{5};
else
...
[mVE,~] = MEanFieldEst_SingleCell('e', f_EnIIni, ...
                                         N_EE,N_EI,N_IE,N_II,...
                                         S_EE,S_EI,S_IE,S_II,p_EEFail,...
                                         lambda_E,S_Elgn,rE_amb,S_amb,...
                                         lambda_I,S_Ilgn,rI_amb,...
...
f_EnI0 = MeanFieldEst_BkGd_ref(N_EE,N_EI,N_IE,N_II,...
                                   S_EE,S_EI,S_IE,S_II,p_EEFail,...
                                   lambda_E,S_Elgn,rE_amb,S_amb,...
                                   lambda_I,S_Ilgn,rI_amb,...
...
function f_EnI = MeanFieldEst_BkGd_ref(N_EE,N_EI,N_IE,N_II,...
                                   S_EE,S_EI,S_IE,S_II,p_EEFail,...
                                   lambda_E,S_Elgn,rE_amb,S_amb,...
                                   lambda_I,S_Ilgn,rI_amb,...
                                   gL_E,gL_I,Ve,Vi,mVE,mVI,...
